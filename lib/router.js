...
Router.map(function() {
  ...
  this.route('waiterRoot', {path: '/tables', waitOn: function() { return [Meteor.subscribe('tables'), Meteor.subscribe('messages'), Meteor.subscribe('orders'), Meteor.subscribe('tabs')]; }});
});